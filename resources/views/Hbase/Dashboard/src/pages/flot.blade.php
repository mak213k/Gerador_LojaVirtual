...
<body>
    ...
    <script src="{{asset('/sbAdmin')}}/vendor/flot/excanvas.min.js"></script>
    <script src="{{asset('/sbAdmin')}}/vendor/flot/jquery.flot.js"></script>
    <script src="{{asset('/sbAdmin')}}/vendor/flot/jquery.flot.pie.js"></script>
    <script src="{{asset('/sbAdmin')}}/vendor/flot/jquery.flot.resize.js"></script>
    <script src="{{asset('/sbAdmin')}}/vendor/flot/jquery.flot.time.js"></script>
    <script src="{{asset('/sbAdmin')}}/vendor/flot-tooltip/jquery.flot.tooltip.min.js"></script>
    <script src="{{asset('/sbAdmin')}}/data/flot-data.js"></script>
